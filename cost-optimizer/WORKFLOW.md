...
> **ConfigHub Documentation**: For detailed explanations of units, workers, targets, and apply operations, see [docs.confighub.com](https://docs.confighub.com). This document covers cost-optimizer-specific workflow.
